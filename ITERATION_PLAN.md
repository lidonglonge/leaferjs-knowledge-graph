...
### Iteration 0: Vue3 + Element Plus 演示项目 (当前迭代)
...
- [ ] **0.1 初始化 Vue3 项目**
  ...
  - 安装 Element Plus
  - 配置路径别名
  - 文件夹: `examples/vue3-demo/`

- [ ] **0.2 集成知识图谱插件**
  - 本地链接 leaferjs-knowledge-graph 包
  - 安装 leafer-ui 依赖
  - 配置插件引入
...
| 迭代 | 任务 | 预计工时 | 截止日期 |
|------|------|----------|----------|
| Iteration 0 | Vue3 演示项目 | 2-3h | 2026-03-05 |
| Iteration 1 | 数据监听机制 | 2-4h | 2026-03-06 |
